...
Если вам необходимо только автоматически получать выписки из банка, то вы можете рассмотреть способ, описанный в [разделе](https://github.com/artik008/Alfa-link_1C_Directbank_via_API)
...
Программа запросит выбор файл с диска и создаст настройку обмена (подробнее тут: [Инструкция по настройке 1С Директбанк](https://its.1c.ru/db/metod81#content:5375:hdoc@2fdb754e)).
